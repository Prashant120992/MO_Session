...
# List is indexed.
# It can have a duplicate elements.
...
print(list1)  # It will give output in same sequence.
list2 = ["Prashant", 31, 95000.0, True]
print(list2)
# To calculate the length
print(len(list2))

# We can also concatenate both list
...
# When we give the index which is not exist then it will return an error "IndexError: list index out of range".
...
# To count the number of occurrences of specific object from the list, we have 2 ways.
...
print(list6[1::-1])
print(list6[1:4])
# print(list6[1:4]) here the 4 is stop counter. It will not include 4th element that is 90.
...
list7[0] = 222  # Replacing value of 0th index(12) with 222
print(list6)
list7.append(888)  # Appending the last value with 888 at the last.
print(list7)
# We can append any type of value.
list7.append("Python")
print(list7)
...
# Let's say if we have 2 lists and extend first list with 2nd list. Then we can make use of extend.
list8 = [1, 2, 3]
list9 = ["Python", "CS"]
list8.extend(list9)
print(list8)
...
list10.pop()
print(list10)
# The last value from the list will be removed when passing empty pop. It is also applicable for string as well.
list11 = ["Bangalore", "Belagavi", "Shimoga", "Hubli", " "]
list11.pop()
print(list11)
# If we want to remove specific element from the list, then we need to pass its index value.
...
print("************************SORT***************************")
list13 = [5, 8, 1, 2, 7, 6, 4, 9, 10, 3, 4]
print(list13)
list13.sort()
print(list13)  # Provides ascending order sorting.
list13.reverse()
print(list13)  # Sorts in reverse order.
...
# If we need to access the element within the list then give the list first then within index later.
print(mylist1[4][1])
